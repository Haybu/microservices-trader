...
public class AccountServiceTest {
	...
	public void doFindAccountUserId() {
		when(repo.findByUserid(ServiceTestConfiguration.USER_ID)).thenReturn(ServiceTestConfiguration
				.account());
		assertEquals(service.findAccount(ServiceTestConfiguration.USER_ID).toString(),ServiceTestConfiguration
				.account().toString());
	}
	/**
	...
	public void doFindAccountByAuthToken() {
		when(repo.findByAuthtoken(ServiceTestConfiguration.AUTH_TOKEN)).thenReturn(ServiceTestConfiguration
				.account());
		
		assertEquals(service.findAccountprofileByAuthtoken(ServiceTestConfiguration.AUTH_TOKEN).toString(),ServiceTestConfiguration
				.account().toString());
	}
	/**
	...
	public void testLogin() {
		...
		when(repo.save(ArgumentMatchers.isA(Account.class))).thenReturn(acc);
