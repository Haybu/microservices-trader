 ...
 */
    ...
    public void getQuotesOneQuote() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(
                        jsonPath("$[0].Change",Matchers
								.closeTo(TestConfiguration.QUOTE_CHANGE, new BigDecimal(0.01))))
                .andExpect(
                        jsonPath("$[0].ChangePercent", Matchers
								.closeTo(TestConfiguration.QUOTE_CHANGE_PERCENT, 0.01)))
                .andExpect(
